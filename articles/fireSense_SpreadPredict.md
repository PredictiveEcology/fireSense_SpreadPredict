...
<tbody>
  ...
  <tr>
   ...
   <td style="text-align:left;"> NA </td>
   <td style="text-align:left;"> NA </td>
   <td style="text-align:left;"> optional. Maximum fire spread average to be passed to the `.objFun`.This puts an upper limit on `spreadProb` during optimization. Expected to be same as fireSpread_SpreadFit parameter value </td>
  </tr>
  <tr>
   <td style="text-align:left;"> mutuallyExclusiveCols </td>
   <td style="text-align:left;"> list </td>
   <td style="text-align:left;"> fuels </td>
   <td style="text-align:left;"> NA </td>
   <td style="text-align:left;"> NA </td>
