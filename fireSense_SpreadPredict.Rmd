...
- An or several objects of class `RasterLayer` or `RasterStack`, or named lists of `RasterLayer` or `RasterStack` in which to look for variables with which to predict.
