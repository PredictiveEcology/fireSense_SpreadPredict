...
origRPath <- setLibPaths("~/tmpFireSenseRPackages4/")   # keep R packages isolated in their own folder
Sys.setenv("R_REMOTES_UPGRADE" = "never") # See ?install_github -- Just install whatever is available; don't ask for further updates

Require(c("magrittr", "raster", "SpaDES.core", "SpaDES.tools"))
Require("SpaDES.core", dependencies = TRUE) # TRUE her means install Suggests too
